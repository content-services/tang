...
// RpmRepositoryVersionModuleStreams provides a mock function with given fields: ctx, hrefs, rpmNames, search, pageOpts
func (_m *MockTangy) RpmRepositoryVersionModuleStreams(ctx context.Context, hrefs []string, rpmNames []string, search string, pageOpts PageOptions) ([]ModuleStreams, int, error) {
	ret := _m.Called(ctx, hrefs, rpmNames, search, pageOpts)

	if len(ret) == 0 {
		panic("no return value specified for RpmRepositoryVersionModuleStreams")
	}

	var r0 []ModuleStreams
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string, string, PageOptions) ([]ModuleStreams, int, error)); ok {
		return rf(ctx, hrefs, rpmNames, search, pageOpts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string, string, PageOptions) []ModuleStreams); ok {
		r0 = rf(ctx, hrefs, rpmNames, search, pageOpts)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, []string, string, PageOptions) int); ok {
		r1 = rf(ctx, hrefs, rpmNames, search, pageOpts)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []string, []string, string, PageOptions) error); ok {
		r2 = rf(ctx, hrefs, rpmNames, search, pageOpts)
	} else {
		r2 = ret.Error(2)
	}
