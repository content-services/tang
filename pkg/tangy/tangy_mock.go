...
func (_m *MockTangy) RpmRepositoryVersionModuleStreamsList(ctx context.Context, hrefs []string, filterOpts ModuleStreamListFilters, SortBy string) ([]ModuleStreams, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, ModuleStreamListFilters, string) ([]ModuleStreams, int, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, ModuleStreamListFilters, string) int); ok {
		r1 = rf(ctx, hrefs, filterOpts, SortBy)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []string, ModuleStreamListFilters, string) error); ok {
		r2 = rf(ctx, hrefs, filterOpts, SortBy)
	} else {
		r2 = ret.Error(2)
	}
