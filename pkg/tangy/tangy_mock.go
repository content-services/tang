...
// RpmRepositoryVersionModuleStreamsList provides a mock function with given fields: ctx, hrefs, filterOpts, pageOpts
func (_m *MockTangy) RpmRepositoryVersionModuleStreamsList(ctx context.Context, hrefs []string, filterOpts ModuleStreamListFilters, pageOpts PageOptions) ([]ModuleStreams, int, error) {
	ret := _m.Called(ctx, hrefs, filterOpts, pageOpts)
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, ModuleStreamListFilters, PageOptions) ([]ModuleStreams, int, error)); ok {
		return rf(ctx, hrefs, filterOpts, pageOpts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, ModuleStreamListFilters, PageOptions) []ModuleStreams); ok {
		r0 = rf(ctx, hrefs, filterOpts, pageOpts)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, ModuleStreamListFilters, PageOptions) int); ok {
		r1 = rf(ctx, hrefs, filterOpts, pageOpts)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []string, ModuleStreamListFilters, PageOptions) error); ok {
		r2 = rf(ctx, hrefs, filterOpts, pageOpts)
	} else {
		r2 = ret.Error(2)
	}
